<template>
  <div class="bg-blue h-16 md:h-12 flex flex-nowrap overflow-hidden max-w-7xl m-auto">
    <div class="space-y-1 p-5 md:p-3 flex flex-col self-center cursor-pointer">
    ...
    <div class="p-5 pr-0 md:p-3" @click="socialVisibleOnMobile = !socialVisibleOnMobile">
      ...
      <div class="flex gap-2 h-6">
        <IconLink :linkUrl="social.facebook" imgUrl="/icons/Facebook.png" imgAlt="Facebook" class="hidden md:block" />
        <IconLink :linkUrl="social.twitter" imgUrl="/icons/Twitter.png" imgAlt="Twitter" class="hidden md:block" />
        <IconLink linkUrl="#" imgUrl="/icons/Email.png" imgAlt="Email" class="hidden md:block" />
      </div>
    </div>
    <div v-if="socialVisibleOnMobile" class="md:hidden absolute top-16 right-12 bg-blue flex flex-col gap-1 p-2">
